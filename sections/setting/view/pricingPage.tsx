        ...
        <Tabs defaultValue="ratio-settings" className="space-y-4">
          ...
          <TabsContent value="ratio-settings" className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-muted-foreground">
                Claude 5 分钟缓存创建（写入）相对文本输入价格的倍率，仅对
                claude- 模型生效，未配置默认 1.25。
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-muted-foreground">
                Claude 1 小时缓存创建（写入）相对文本输入价格的倍率，仅对
                claude- 模型生效，未配置默认 2.0。
              </p>
            </div>
          </TabsContent>
                  ...
                  <div className="space-y-5 py-2">
                    ...
                    <div className="rounded bg-muted/50 p-2 font-mono text-xs text-muted-foreground">
                      ...
                      {editingRow.model_name.startsWith('claude-') && (
                        <>
                          {' '}
                          · 缓存创建5m {editingRow.claude_cache_5m_ratio ||
                            '-'}{' '}
                          · 缓存创建1h {editingRow.claude_cache_1h_ratio || '-'}
                        </>
                      )}{' '}
                      · 图入 {editingRow.image_input_ratio || '-'} · 图出{' '}
